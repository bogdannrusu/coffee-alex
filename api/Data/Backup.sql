...
-- Script date 01.07.2024 17:39:20
...
--
-- Drop procedure `insert_orders_create`
--
DROP PROCEDURE IF EXISTS insert_orders_create;
...
CREATE TABLE orders (
  ...
  good_package_id varchar(255) DEFAULT NULL,
...
--
-- Create procedure `insert_orders_create`
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE insert_orders_create (IN p_good_id int, IN p_quantity decimal(8, 2), IN p_price decimal(8, 2), IN p_total_price decimal(8, 2))
BEGIN


  INSERT INTO orders
    VALUES (good_id = p_good_id, quantity = p_quantity, price = p_price, total_price = p_total_price)
  ;
...
CREATE TABLE acquisitions (
  ...
  deposit_entry varchar(100) NOT NULL,
